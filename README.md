...
| Method | Avg. $\Delta E_{\mathrm{d}}$ | Stability | Novelty | S∩N | Prototype novelty | Prototype S∩N |
|--------|:------------------:|:-------------:|:------------:|:--------:|:----------------------:|:------------------:|
| [Random](https://arxiv.org/abs/2501.02144) | 247.8 | 4.2% | **98.4%** | 3.8% | 0% | 0% |
| [Ion exchange](https://pubs.acs.org/doi/10.1021/ic102031h) | **93.1** | 19.0% | 70.6% | **7.4%** | 0% | 0% |

*Statistics are based on 500 structures generated by each method.*

* **Avg. $\Delta E_{\mathrm{d}}$**: The average [decomposition energy](https://link.springer.com/article/10.1007/s10853-022-06915-4), which measures the thermodynamic stability of a material relative to competing phases.
* **Stability**: The percentage of generated materials that are on the hull defined by stable entries from the [Materials Project](https://next-gen.materialsproject.org/).
* **Novelty**: Assessed based on the absence of a material from the Materials Project.
* **S∩N**: The percentage of materials that are both stable and novel under these definitions.
