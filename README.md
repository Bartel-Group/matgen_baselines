...
### Generative models
| Method | Stability | Novelty | S∩N | Prototype novelty | Prototype S∩N |
|--------|:-------------:|:------------:|:--------:|:----------------------:|:------------------:|
| [FTCP](https://github.com/PV-Lab/FTCP) | **26.8%** | 49.2% | 5.6% | 8.2% | 0% |
| [CDVAE](https://github.com/txie-93/cdvae) | 6.4% | 96.4% | 4.8% | **16.4%** | 0% |
| [CrystaLLM](https://github.com/lantunes/CrystaLLM) | 1.4% | 91.4% | 1.1% | 6.4% | 0% |
### Template-based methods
| Method | Stability | Novelty | S∩N | Prototype novelty | Prototype S∩N |
|--------|:-------------:|:------------:|:--------:|:----------------------:|:------------------:|
| [Random](https://arxiv.org/abs/2501.02144) | 4.2% | **98.4%** | 3.8% | 0% | 0% |
| [Ion exchange ](https://pubs.acs.org/doi/10.1021/ic102031h) | 19.0% | 70.6% | **7.4%** | 0% | 0% |

*Statistics are based on 500 structures generated by each method.*

The stability rate is the percentage of generated materials that are on the hull defined by stable entries from the Materials Project. Novelty is assessed based on the absence of a material from the Materials Project. The S∩N rate is the percentage of materials that are both stable and novel under these definitions. Also listed is the prototype novelty rate, defined as the percentage of proposed materials whose structures cannot be indexed to a known prototype in the [AFLOW](https://www.aflowlib.org/prototype-encyclopedia/) database, and the stability rate of materials in these novel prototypes (S∩N). The bold value in each column denotes the highest rate achieved among all methods.
